...
public class ServiceAspect {
    ...
    @Pointcut("execution(* repotest.app.server.service..*..*(..)) && !within(repotest.app.server.service.sessionmgt.SessionDataMgtService+)")
    ...
    @Pointcut("execution(* repotest.app.server.service..get*(..))")
